 ...
 *         one number duplicated in the array. How do you find the duplicated
 *         number? FOr e.g. if an array with length contains numbers
 *         {0,2,1,3,2}, the duplicated number is 2.
 */
